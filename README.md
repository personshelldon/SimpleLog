...
annotationProcessor 'com.don11995.log:simple-log-processor:1.4.2'
// if You are using Kotlin with Java
kapt 'com.don11995.log:simple-log-processor:1.4.2'
implemetation 'com.don11995.log:simple-log:1.4.2'
```
